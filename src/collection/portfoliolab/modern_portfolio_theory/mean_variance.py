...
class MeanVarianceOptimisation:
    ...
    def __init__(self, calculate_expected_returns='mean', risk_free_rate=0.03):
        ...
        devadarsh.track('MeanVarianceOptimisation')

        # Silencing a specific warning until the CVXPY is updated.
        warnings.filterwarnings("ignore", message="`np.complex` is a deprecated alias for the builtin `complex`")

...
from mlfinlab.microstructural_features.entropy import (get_shannon_entropy, get_plug_in_entropy,
                                                       get_lempel_ziv_entropy, get_konto_entropy)
...
class MicrostructuralFeaturesGenerator:
    ...
    def get_features(self, verbose=True, to_csv=False, output_path=None):
        ...
        for batch in self.generator_object:  # pragma: no cover
            if verbose:
